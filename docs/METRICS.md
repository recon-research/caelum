...
**Window:** last 90 days (since 2026-05-02) · **Generated:** 2026-07-31 · **Source:** `gh` (tracker + CI), via `scripts/metrics.py`
...
Review pickup (PR open→merge): median 1m over 40 merge(s) · halves 2m → 1m -- alarm: newer half ≥2× older and ≥1h (saturation shows here first).
...
Fastest-growing docs (net lines this window): `docs/PATTERNS.md` +617 · `docs/MIGRATION.md` +380 · `.claude/skills/EVALS.md` +294 · `.claude/skills/design_review/references/house-style.md` +275 · `docs/AUTOMATION.md` +155 *(a process doc growing with no matching slices is the journaling smell -- eyeball it)*
