...
**Window:** last 90 days (since 2026-04-06) · **Generated:** 2026-07-05 · **Source:** `gh` (tracker + CI), via `scripts/metrics.py`
...
|---|---|---|---|
| Throughput | 6.1/wk | trend only | Merged PRs per week. A trend line, not a target -- a sudden drop flags a blocker. |
...
*Sample this window: 79 PR(s) merged, 0 `bug`(s) filed, 100 PR CI run(s), 5 decision(s) closed. Small samples are noisy -- treat single-digit windows as directional, not controlled.*
