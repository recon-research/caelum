...
|---|---|---|---|---|---|---|---|
| docs | 25 | 1m | $23.79 (n=3) | 4.6k (n=1) | 12 | 0 (n=1) | 1 (n=5) |
| fix | 7 | 13m | $15.09 (n=5) | 40.5k (n=4) | 84 | 0 (n=4) | 1 (n=6) |
...
Fastest-growing docs (net lines this window): `docs/PATTERNS.md` +406 · `docs/MIGRATION.md` +377 · `.claude/skills/EVALS.md` +294 · `.claude/skills/design_review/references/house-style.md` +275 · `docs/AUTOMATION.md` +155 *(a process doc growing with no matching slices is the journaling smell -- eyeball it)*
