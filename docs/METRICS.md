...
|---|---|---|---|---|---|---|---|
| docs | 25 | 1m (n=24) | $17.48 (n=2) | 4.6k (n=1) | 12 | 0 (n=1) | 1 (n=3) |
| fix | 7 | 13m | $15.09 (n=5) | 60.4k (n=5) | 84 | 0 (n=5) | 1 (n=6) |
...
Fastest-growing docs (net lines this window): `docs/PATTERNS.md` +406 · `docs/MIGRATION.md` +378 · `.claude/skills/EVALS.md` +294 · `.claude/skills/design_review/references/house-style.md` +275 · `docs/AUTOMATION.md` +155 *(a process doc growing with no matching slices is the journaling smell -- eyeball it)*
