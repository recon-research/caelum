...
| **On-demand** | [#667](https://github.com/recon-research/caelum/issues/667) (knob, org-chart, mega-menu, dock) · [#712](https://github.com/recon-research/caelum/issues/712) (standalone paginator, data-view, meter-group, cascade-select, mention, colour-picker, speed-dial, key-filter) | Built when someone asks. If you need one, say so on the issue. |
