...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — shipped: density R4 #411 · a11y Layer 1 axe #690+#691 · hardening batch (PRs #697–#705) · adoption #713/#716 · harness #240 · VR suite #732 · **#734 ◐** (#425 contrast, #510 bridge). **#405 sweep 11/12.** **Ledger ☑ #733 + ☑ #774 + ☑ #773** — [`docs/CAPABILITY_LEDGER.md`](CAPABILITY_LEDGER.md), gated in preflight/CI, so the M4 exit criterion is mechanically evaluable: **64/64 `adversarial-passed`** + 1 proven exemption (`shared`, type-only). **☑ #779** axe settles before reading. **☑ #785** the sweep grades the 5 form controls in error state, not just pristine. Recipes → `docs/PATTERNS.md` §9–§9f/§12–§13. Remaining: #405 · #413.
