...
- **Slices:** ☑ **density parity (R4)** #411 (PR #415; runtime `[data-density]` compact arm, Material `density:-2` + `--cae-space-*` under one selector, target floor held; D-19 ratified #412) · ◐ theming polish #734 (#425 contrast, prov. #744; #510 bridge; #413 left) · ◐ full a11y audit — **Layer 1 axe ☑** #690+#691 (PR #695: 60 components axe-clean, 0 real violations); keyboard/SR + real-browser → ☑ **harness** #240 (PR #719), ◐ **#405** sweep 11/12 (#718, #724; only #228 left — real-SR, by design) · ☑ **visual-regression** #732 (PRs #737/#742; 5 components x 4 arms, render pinned per #735) · ☑ capability ledger #733 + #773 · ☑ **`p-*`→`cae-*` migration guide** `docs/MIGRATION.md` #715
- **Exit criterion:** the parity checklist is green; the capability ledger shows every shipped component at `adversarial-passed` (bar a proven exemption); the adoption guide is published.
- **Leverage:** mixed — automation/audit high; final parity judgment ~1×.
- **Status:** ◐ **active** (M3 exited 2026-07-24) — shipped: density R4 #411 · a11y Layer 1 axe #690+#691 · hardening batch (PRs #697–#705) · adoption #713/#716 · harness #240 · VR suite #732 (+#736, #745) · **#734 ◐** (#425 contrast, #510 bridge). **#405 sweep 11/12.** **Ledger ☑ #733 + ☑ #774 + ☑ #773** — [`docs/CAPABILITY_LEDGER.md`](CAPABILITY_LEDGER.md), generated + gated in preflight/CI, so the M4 exit criterion is mechanically evaluable: **64/64 at `adversarial-passed`** + 1 proven exemption (`shared`, type-only). **☑ #779** — axe waits for the render to settle, so it no longer grades mid-fade blends. Recipes → `docs/PATTERNS.md` §9–§9f/§12–§13. Remaining: #405 · #413.
