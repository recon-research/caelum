...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — shipped: density R4 #411 · a11y Layer 1 axe #690+#691 · hardening batch (PRs #697–#705) · adoption #713/#716 · harness #240 · VR suite #732 (+#736, #745) · **#734 ◐** (#425 contrast, #510 bridge). **#405 sweep 11/12.** **Capability ledger ☑ #733** — [`docs/CAPABILITY_LEDGER.md`](CAPABILITY_LEDGER.md), generated + gated in preflight/CI, so the M4 exit criterion is now mechanically evaluable: **59/65 entry points at `adversarial-passed`**, 6 gaps ticketed (#773 axe ×5, #774 panel-menu sign-off). Recipes → `docs/PATTERNS.md` §9–§9f/§12. Remaining: #405 · #413 · #773 · #774.
