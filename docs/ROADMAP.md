...
- **Slices:** ☑ **density parity (R4)** #411 (PR #415; runtime `[data-density]` compact arm, Material `density:-2` + `--cae-space-*` under one selector, target floor held; D-19 ratified #412) · ☐ theming polish #734 (blocked on VR) · ◐ full a11y audit — **Layer 1 axe ☑** #690+#691 (PR #695: 60 components axe-clean, 0 real violations); keyboard/SR + real-browser → ☑ **harness** #240 (PR #719), ◐ **#405** sweep 3/12 (#718, #724, PRs #728/#730) · ◐ **visual-regression** #732 (PR #737; `cae-button` arms, render pinned per #735) · ☐ capability ledger #733 · ☑ **`p-*`→`cae-*` migration guide** `docs/MIGRATION.md` #715
...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — density parity R4 (#411); **a11y Layer 1 axe complete** (#690+#691, PR #695). **Hardening batch 07-24** (PRs #697–#705). **Adoption track done** (PRs #713, #716). **Real-browser harness** #240 (PR #719), then the **#405 sweep** 3/12: #718 (PR #722) · #724 (PR #726) · divider+toolbar (PR #728) · slider (PR #730). **VR suite** #732 (PR #737) — goldens portable only with the render pinned (#735, measured across dev/container/CI). **#736** (PR #739) completed #724's other half — `loadCaelumTheme()` loads the whole bridge. Recipes → `docs/PATTERNS.md` §9/§9a/§9b/§12. Remaining: #405 · #732 · theming polish #734 · capability ledger #733.
