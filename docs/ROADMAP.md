...
- **Slices** (★ = team-priority): ☑ ★ **media cluster** — carousel #273 · galleria #274 · image #275 · image-compare #293 (COMPLETE) · ☑ ★ **tree** — tree-select #279 · tree-table #262 · ☑ **input family** — input-number #301 · input-otp #303 · password #304 · input-mask #302 (COMPLETE) · ☑ **Splitter family** — splitter #323 · scroll-panel #328 (COMPLETE) · ☑ **drag-drop cluster** — order-list #336 · pick-list #337 · file-upload #338 (COMPLETE) · ☑ **breadcrumb** #332 · **M3-exit set** (ticketed 07-23, build order): ☑ display #662 (skeleton·avatar·timeline·tag) · ☑ rating #663 · ☐ popover+confirm-popup #664 · ☐ panel-menu #665 · ☐ datepicker #666 · niche #667.
...
- **Status:** ◐ **active** (D-18). ★ families COMPLETE: media, tree, input, Splitter, drag-drop; breadcrumb #332 shipped. **D-596 icons COMPLETE**; **D-595 routerLink OPEN** (#333 → `caelum/breadcrumb-router`; #165/#150 copy it); **#652 FIXED** — `caelum/grid-tanstack` split (D-652). **M3-exit set** (07-23, CI-core-first): ☑ #662 display cluster (defer #669) · ☑ #663 cae-rating (`caelum/rating`, selection-control CVA #47, roving radiogroup, D-596 icons; extras #675) · ☐ #664 popover+confirm-popup (NEXT) · ☐ #665 panel-menu · ☐ #666 datepicker · niche #667. Naming per COMPARISON: Calendar → **`cae-datepicker`**, OverlayPanel → **`cae-popover`**. Per-ticket detail → the tracker.
