...
- **Slices:** ☑ **density parity (R4)** #411 (PR #415; D-19 ratified #412) · ◐ theming polish #734 (#425 contrast per D-744; #510 bridge; #413 = the density mixin, mixin-only (D-757)) · ◐ full a11y audit — **Layer 1 axe ☑** #690+#691 (PR #695) + ☑ #785 (error state); keyboard/SR + real-browser → ☑ **harness** #240 (PR #719), ☑ **#405** retired 11/12 (D-771; #718, #724; #228 = standing manual pass), ☑ #759 accordion roving · ☑ **visual-regression** #732 (PRs #737/#742; 5 components x 4 arms, render pinned per #735) · ☑ capability ledger #733 + #773 · ☑ **`p-*`→`cae-*` migration guide** `docs/MIGRATION.md` #715
...
- **Status:** ◐ **active** — shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR #732 · **#734 ◐** (#425, #510). **#405 ☑** (D-771). **Ledger ☑ #733/#774/#773** — [`docs/CAPABILITY_LEDGER.md`](CAPABILITY_LEDGER.md), gated: **64/64 `adversarial-passed`** + 1 proven exemption. a11y: **☑ #779** axe settles first · **☑ #785** error state scanned · **☑ #765** modals trap at attach (prov. #791) · **☑ #759** accordion roving (D-623 reach; upstream #796) · **☑ #741** pre-touched controls surface their error (shared base). Recipes → `docs/PATTERNS.md` §9–§9l/§12–§13. Remaining: **#413** density mixin (D-757 — parameterize both arms).
