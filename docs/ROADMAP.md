...
- **Status:** ◐ **in progress** (opened 2026-07-28, at `0454a3d`). **Parity CLOSED 5/5** at `ec6654d`; **clause (1) met** (88 mapped / **14** planned / 0 untracked). **#514** `72a348f` + **#851** `345a120`. **#852 HELD by owner 2026-07-30**. Ledger **68/68**. Since: **#919** `0b59b3e` (**D-851**) · **#879** `2cf17b9` · **drawer #855–#858** `6227811` · **menu family** `c7fde82`…`61c304a` (**D-858**, **D-859**) → **#989** `8779265` (4-lens review; D-859's grounding falsified) → **#993** spiked: own `host` beats `hostDirectives` → **#998** collapsed the two-branch at menubar + split-button (split-button's focus machinery deleted, menubar's kept). Open: **#992**/**#994**.
