...
- **Slices:** ☑ **density parity (R4)** #411 (PR #415; runtime `[data-density]` compact arm, Material `density:-2` + `--cae-space-*` under one selector, target floor held; D-19 ratified #412) · ☐ theming polish #734 (unblocked by #732) · ◐ full a11y audit — **Layer 1 axe ☑** #690+#691 (PR #695: 60 components axe-clean, 0 real violations); keyboard/SR + real-browser → ☑ **harness** #240 (PR #719), ◐ **#405** sweep 3/12 (#718, #724, PRs #728/#730) · ☑ **visual-regression** #732 (PRs #737/#742; 5 components x 4 arms, render pinned per #735) · ☐ capability ledger #733 · ☑ **`p-*`→`cae-*` migration guide** `docs/MIGRATION.md` #715
...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — density parity R4 (#411) · **a11y Layer 1 axe** #690+#691 · hardening batch 07-24 (PRs #697–#705) · adoption track (#713, #716) · **harness** #240 · **#405 sweep 3/12** (PRs #722/#726/#728/#730) · **VR suite ☑ #732** (PRs #737/#742) — 5 components x 4 arms, render pinned per #735; the extension exposed three defects one component could not (background bound to a non-existent token · inherited font left 3 of 4 goldens unpinned · a mismatch reported as a 15s timeout) · **#736** (PR #739) completed #724's half. Recipes → `docs/PATTERNS.md` §9/§9a/§9b/§12. Remaining: #405 · #734 (unblocked) · #733.
