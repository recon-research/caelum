...
- **Slices:** ☑ **density parity (R4)** #411 (PR #415; runtime `[data-density]` compact arm, Material `density:-2` + `--cae-space-*` under one selector, target floor held; D-19 ratified #412) · ◐ theming polish #734 (started: semantic-colour text contrast #425 fixed, provisional on #744) · ◐ full a11y audit — **Layer 1 axe ☑** #690+#691 (PR #695: 60 components axe-clean, 0 real violations); keyboard/SR + real-browser → ☑ **harness** #240 (PR #719), ◐ **#405** sweep 3/12 (#718, #724, PRs #728/#730) · ☑ **visual-regression** #732 (PRs #737/#742; 5 components x 4 arms, render pinned per #735) · ☐ capability ledger #733 · ☑ **`p-*`→`cae-*` migration guide** `docs/MIGRATION.md` #715
...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — density parity R4 (#411) · **a11y Layer 1 axe** #690+#691 · hardening batch 07-24 (PRs #697–#705) · adoption track (#713, #716) · **harness** #240 · **#405 sweep 3/12** (PRs #722/#726/#728/#730) · **VR suite ☑ #732** (PRs #737/#742; render pinned per #735) · **#736** (PR #739) completed #724's half · **#734 started** — semantic-colour text contrast #425 fixed (two primitives darkened; `sunken` was the binding surface, not `base`), pinned by `theming/contrast.browser.spec.ts`, provisional on **#744**; VR has no status-palette arm → #745. Recipes → `docs/PATTERNS.md` §9/§9a/§9b/§9c/§12. Remaining: #405 · #734 (rest) · #733.
