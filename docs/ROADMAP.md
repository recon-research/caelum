...
- **Slices** (★ = team-priority): ☑ ★ **media cluster** — carousel #273 · galleria #274 · image #275 · image-compare #293 (COMPLETE) · ☑ ★ **tree** — tree-select #279 · tree-table #262 · ☑ **input family** — input-number #301 · input-otp #303 · password #304 · input-mask #302 (COMPLETE) · ☑ **Splitter family** — splitter #323 · scroll-panel #328 (COMPLETE) · ☑ **drag-drop cluster** — order-list #336 · pick-list #337 · file-upload #338 (COMPLETE) · ☑ **breadcrumb** #332 · **M3-exit set** (ticketed 07-23, build order): ☑ display #662 (skeleton·avatar·timeline·tag) · ☑ rating #663 · ☑ popover+confirm-popup #664 · ☑ panel-menu #665 · ◐ datepicker #666 (stage 1 #684) · niche #667.
...
- **Status:** ◐ **active** (D-18). ★ families COMPLETE: media, tree, input, Splitter, drag-drop; breadcrumb #332 shipped. **D-596 icons COMPLETE**; **D-595 routerLink OPEN** (#333 → `caelum/breadcrumb-router`; #165/#150 copy it); **#652 FIXED** — `caelum/grid-tanstack` split (D-652). **M3-exit set** (07-23, CI-core-first): ☑ #662 display cluster (→#669) · ☑ #663 cae-rating (CVA #47, D-596; →#675) · ☑ #664 popover+confirm-popup (`caelum/popover`; `confirmAt()` on the ONE confirm service; →#677) · ☑ #665 panel-menu (composes CaeAccordion + CaeMenuItem; →#680) · ◐ #666 datepicker (stage 1 #684 single/range/inline; stage 2 pending; →#683) · niche #667. Per-ticket detail → the tracker.
