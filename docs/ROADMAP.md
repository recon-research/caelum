...
- **Slices:** ☑ **density parity (R4)** — *pulled forward*, shipped #411 (PR #415; runtime `[data-density]` compact arm, Material `density:-2` + `--cae-space-*` re-scale under one selector, target-size floor held; API shape = D-19, ratified #412) · ☐ theming polish (visual polish across density × scheme) · ◐ full a11y audit — **Layer 1 axe ☑** (#690 harness + #691 sweep, PR #695: 60 components axe-clean, 0 real violations); keyboard/SR + real-browser → ☑ **harness** #240 (PR #719), ◐ **#405** sweep (first find ☑ #718, PR #722) · ☐ visual-regression suite (light+dark, incl. density arms) · ☐ capability ledger green · ☑ **`p-*`→`cae-*` migration guide** `docs/MIGRATION.md` #715
...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — density parity R4 (#411); **a11y Layer 1 axe complete** (#690+#691, PR #695: 60 components axe-clean, 0 real violations). **Hardening batch 07-24** (PRs #697–#705): #563/#419 · #642 · #532 · #669 · #571 · #491 · #509. **Adoption track done** (PRs #713, #716). **Real-browser harness shipped** (#240, PR #719) — unblocks the **#405** sweep (verify followups rolled in at the 07-13 triage); its first spec found #718 (grid `role=status` axe critical), fixed same-day (PR #722); heuristic → `docs/PATTERNS.md` §12. Remaining: theming polish · #405 sweep · visual-regression suite · capability ledger green.
