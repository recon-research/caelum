...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — shipped: density R4 #411 · a11y Layer 1 axe #690+#691 · hardening batch (PRs #697–#705) · adoption #713/#716 · harness #240 · VR suite #732 (+#736, #745) · **#734 ◐** (#425 contrast, #510 bridge). **#405 sweep 10/12.** Recipes → `docs/PATTERNS.md` §9–§9f/§12. Remaining: #405 · #413 · #733.
