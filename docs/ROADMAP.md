...
- **Status:** ◐ **in progress** (opened 2026-07-28, at `0454a3d`). **Parity track CLOSED 5/5** at `ec6654d`; **clause (1) met** — `audit_comparison.py` grades 88 mapped / **14** planned / 0 untracked, all 14 policy. **#514** at `72a348f` + **#851** at `345a120` — `0.1.0` with a gated release path, dry run green. **#852 HELD by owner direction 2026-07-30** (npm setup waits). Ledger **68/68**; `autocomplete`'s row re-keyed to PR #910 (PR #912, † per #860; #897/#898 cleared the review's do-not-sign); #899 landed `f3f3be9`, #886 fixed `fc5725a`; left: #900/#901 (+ #915). Order = **D-849**; `0.1.0` = **D-850**. Carried from M4, non-gating: #811/#812/#813/#832/#836/#840/#841 + guards #844/#846.
