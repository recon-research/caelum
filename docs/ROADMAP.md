...
- **Status:** ◐ **active** (the current milestone; advanced here by D-18). ★ families COMPLETE: media, tree, input, Splitter, drag-drop; breadcrumb #332 shipped. Now working the **standing menu** — parity-extras/debt on shipped components (cae-stepper index handling closed out across #592/#597/#598) (extras tracked on #341/#342/#345/#333/#422/#418 + #290/#350/#309/#315/#364/#399; #456 CLOSED → #544/#545/#546). Breadth follow-ups run alongside (cae-table #144/#251/#253/#255, tree-table #264–#270, galleria #286/#289, carousel #276/#559/#571/#574, tree-select #283, chip-set #201/#448/#550-#556, grid extras — landed subsets recorded in the Status block + the PRs). Live landed-slice index + resume point → the `CLAUDE.md` Status block + the tracker.
