...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR #732 · **#734 ◐** (#425, #510). **#405 11/12.** **Ledger ☑ #733/#774/#773** — [`docs/CAPABILITY_LEDGER.md`](CAPABILITY_LEDGER.md), gated in preflight/CI, so the M4 exit criterion is mechanically evaluable: **64/64 `adversarial-passed`** + 1 proven exemption (`shared`, type-only). a11y follow-ups: **☑ #779** axe settles first · **☑ #785** error state scanned · **☑ #765** modals trap at attach (prov. #791). Recipes → `docs/PATTERNS.md` §9–§9f/§12–§13. Remaining: #405 · #413.
