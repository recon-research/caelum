...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — shipped: density R4 #411 · a11y Layer 1 axe #690+#691 · hardening batch (PRs #697–#705) · adoption #713/#716 · harness #240 · VR suite #732 (+#736, #745) · **#734 ◐** (#425 contrast, #510 bridge). **#405 sweep 11/12.** **Ledger ☑ #733 + ☑ #774** (PR #778) — [`docs/CAPABILITY_LEDGER.md`](CAPABILITY_LEDGER.md), generated + gated in preflight/CI, so the M4 exit criterion is mechanically evaluable: **60/65 at `adversarial-passed`**, last gap **#773**. **☑ #779** — axe waits for the render to settle, so it no longer grades mid-fade blends. Recipes → `docs/PATTERNS.md` §9–§9f/§12–§13. Remaining: #405 · #413 · #773.
