...
- **Status:** ◐ **active** (M3 exited 2026-07-24) — density parity R4 (#411); **a11y Layer 1 axe complete** (#690+#691, PR #695). **Hardening batch 07-24** (PRs #697–#705). **Adoption track done** (PRs #713, #716). **Real-browser harness** #240 (PR #719), then the **#405 sweep** 3/12: #718 (PR #722) · #724 (PR #726) · divider+toolbar (PR #728) · slider (PR #730). **VR suite** #732 (PR #737) — goldens portable only with the render pinned (#735, measured across dev/container/CI). Recipes → `docs/PATTERNS.md` §9/§9a/§9b/§12. Remaining: #405 · #732 · theming polish #734 · capability ledger #733.
