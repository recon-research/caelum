...
- **Status:** ◐ **active** — shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR #732 · **#734 ☑** (#425/#510/#413, D-757) · **#405 ☑** (D-771) · a11y ☑ #779/#785/#765/#759/#741. Recipes → `docs/PATTERNS.md` §9–§9l/§12–§13. **Exit NOT met**, graded per clause after the 2026-07-27 `adversarial_review` (#808–#812): **1 ☑** (#808+#810 — reworded, mechanized, green: 88 rows, 19 ☐, 0 untracked) · **2 ☐ — #809 blocks** ([ledger](CAPABILITY_LEDGER.md) 64/64 + 1 exemption, but it proves a pointer resolves, not that a review happened) · **3 ☑** (#715).
