...
- **Exit criterion:** the parity checklist is green; the capability ledger shows every shipped component at `adversarial-passed` (bar a proven exemption); the adoption guide is published. *(Clause 1 names no artifact that exists in the repo — see #808; grade it against `COMPARISON.md`'s Status column, the lesson #706 taught at the M3 exit.)*
- **Leverage:** mixed — automation/audit high; final parity judgment ~1×.
- **Status:** ◐ **active** — shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR #732 · **#734 ☑** (#425, #510, #413). **#405 ☑** (D-771). **Ledger ☑ #733/#774/#773** — [`docs/CAPABILITY_LEDGER.md`](CAPABILITY_LEDGER.md), gated: **64/64 `adversarial-passed`** + 1 proven exemption. a11y ☑ #779 · #785 · #765 · #759 · #741. Recipes → `docs/PATTERNS.md` §9–§9l/§12–§13. **☑ #413** `caelum.theme($density, $density-compact)`, mixin-only (D-757). **Exit NOT met** — the milestone `adversarial_review` ran (2026-07-27) and found clause 1 ungradeable + clause 2 unproven: #808–#812.
