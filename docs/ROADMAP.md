...
- **Status:** ◐ **active** — shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR #732 · **#734 ☑** (#425, #510, #413). **#405 ☑** (D-771). **Ledger ☑ #733/#774/#773** — [`docs/CAPABILITY_LEDGER.md`](CAPABILITY_LEDGER.md), gated: **64/64 `adversarial-passed`** + 1 proven exemption. a11y ☑ #779 · #785 · #765 · #759 · #741. Recipes → `docs/PATTERNS.md` §9–§9l/§12–§13. **☑ #413** `caelum.theme($density, $density-compact)`, mixin-only (D-757). **All M4 exit criteria met; the exit awaits the milestone `adversarial_review`.**
