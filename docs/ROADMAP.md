...
- **Status:** ◐ **active** — shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR #732 · **#734 ☑** (#425/#510/#413, D-757) · **#405 ☑** (D-771) · a11y ☑ #779/#785/#765/#759/#741. Recipes → `docs/PATTERNS.md` §9–§9l/§12–§13. **Exit NOT met**, graded per clause: **1 ☑** (#808+#810 — mechanized, green: 88 rows, 19 ☐, 0 untracked) · **2 ☐** ([ledger](CAPABILITY_LEDGER.md) **63/64**) — #809 verified quotes, re-keyed 13 rows; the 2 self-signed rows FAILED re-review (#823/#824/#825, revoked). **#825 ☑** (PR #833, D-831) and **#823 ☑** (PR #837) won their rows back; only **#824** still owes one, unblocked by **D-826** · **3 ☑** (#715).
