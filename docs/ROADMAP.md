...
- **Status:** ◐ **active** (D-18). ★ families COMPLETE: media, tree, input, Splitter, drag-drop; breadcrumb #332 shipped. Working the **standing menu** — parity-extras/debt on shipped components (#341/#342/#345/#333/#422/#418 + #290/#350/#309/#315/#364/#399; #456 CLOSED → #544/#545/#546). **D-596 icons COMPLETE** — #644 (`caelum/icon` + per-item icon/iconTemplate on breadcrumb/tab-menu/menu/split-button) then #645 (context-menu slot + menubar forward; residuals #648 MatMenu typeahead, #649 iconContext dedupe). Next unlock = routerLink D-595. Breadth follow-ups alongside (table #144/#251/#253/#255, tree-table #264–#270, galleria #286/#289, carousel #276/#559/#571/#574, tree-select #283, chip-set #201/#448/#550-#556). Landed-slice index + resume → `CLAUDE.md` Status + the tracker.
