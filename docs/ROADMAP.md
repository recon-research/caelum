...
- **Status:** ◐ **in progress** (opened 2026-07-28, at `0454a3d`). **Parity CLOSED 5/5** at `ec6654d`; **clause (1) met** — `audit_comparison.py`: 88 mapped / **14** planned / 0 untracked. **#514** `72a348f` + **#851** `345a120` (`0.1.0`, gated). **#852 HELD by owner 2026-07-30**. Ledger **68/68**. #889 batch DONE. **#919** `0b59b3e` (**D-851**) · **#879** `2cf17b9` · **drawer #855–#858** `6227811` (**`strictTemplates` ON**; #854 → **#938**) · **menu family** #962/#960 `c7fde82`, #961/#963 `c4072c2` (**D-858**), **#975** `c645fa7` (Tarjan SCC; #962's start-independence claim was false). Order = **D-849**; `0.1.0` = **D-850**. Carried from M4: #811/#812/#813/#832/#836/#840/#841 + #844/#846.
