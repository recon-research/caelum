...
- **Status:** ◐ **active** — shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR #732 · **#734 ☑** (#425/#510/#413, D-757) · **#405 ☑** (D-771) · a11y ☑ #779/#785/#765/#759/#741. Recipes → `docs/PATTERNS.md` §9–§9l/§12–§13. **Exit NOT met**, graded per clause: **1 ☑** (#808+#810 — mechanized, green: 88 rows, 19 ☐, 0 untracked) · **2 ☐** ([ledger](CAPABILITY_LEDGER.md) **61/64**) — #809 verified the quotes and re-keyed 13 rows off a packaging slice; re-reviewing the 2 self-signed rows FAILED them (6 HIGH → #823/#824/#825, sign-offs revoked; #824 blocked on #826) · **3 ☑** (#715).
