...
- **Status:** ◐ **active** (D-18). ★ families COMPLETE: media, tree, input, Splitter, drag-drop; breadcrumb #332 shipped. Working the **standing menu** — parity-extras/debt on shipped components (#341/#342/#345/#333/#422/#418 + #290/#350/#309/#315/#364/#399; #456 CLOSED → #544/#545/#546). **D-596 icons COMPLETE** — #644 (registry + four components) then #645 (context-menu/menubar; residuals #648/#649). Next unlock = routerLink D-595. Breadth follow-ups alongside: table, tree-table #264–#270, galleria, carousel, tree-select, chip-set — query the tracker by label. Landed-slice index + resume → `CLAUDE.md` Status.
