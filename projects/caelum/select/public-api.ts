/**
 * Secondary entry point `caelum/select` (issue #28, Book 19 §3.2) — importable and
 ...
 */
export * from './select';
// Re-exported so a consumer importing only `caelum/select` can type its `appearance` and
