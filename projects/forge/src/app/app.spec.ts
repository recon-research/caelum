...
describe('App', () => {
  ...
  it('defers the below-the-fold demo sections off the initial bundle (#85)', async () => {
    ...
    await fixture.whenStable();
    const el = fixture.nativeElement as HTMLElement;
    // Exactly twenty-five @defer blocks — the capacity sliders, modules listbox, timezone autocomplete,
    // skills multi-select, members table, tree-table, carousel, galleria, image, image-compare, splitter, tree-select, input-number, input-otp,
    ...
    expect((await fixture.getDeferBlocks()).length).toBe(25);
