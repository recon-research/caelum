...
- `scripts/preflight.*` and `ci.yml` contain no unconfigured SKIP-placeholder stages if the repo has real code; preflight executes end-to-end and reports 0 skipped (`UNWIRED` lines are declined stages, not skips — they stay, #612).
