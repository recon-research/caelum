...
**(b) A secondary entry point** — `projects/caelum/select/ng-package.json`, per §3.2 "can be as simple as `{}`"; ng-packagr derives the name `@recon-research/caelum/select` from the folder:
