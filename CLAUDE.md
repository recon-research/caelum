...
**Resume:** `main` @ `45a6450`, tree clean, CI green · **no in-flight slice** · last shipped: **#405** tree-table a11y + the live-region fix (PR #770) · **decisions: #735, #744, #757** (ratify 07-28), **#771** (ratify 07-29) · **NEXT: #734** theming polish or **#733** capability ledger — both M4 exit criteria; #413 is parked on #757 · new: **#769** (tree-table focus restore), **#771**, #765, #766, #762, #758, #759 · verify: `bash scripts/preflight.sh` **node on PATH** (#538), read the **EXIT CODE** (a pipe to `tail` returns the pipe's), and re-run it **after** doc edits — a stale PASS reddened #753.
