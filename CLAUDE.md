...
**Resume:** `main` @ `ce82155`, tree clean, CI green · this session shipped 4 slices (PRs #530, #533, #536, #538 — **#288 umbrella closed**; spawned #532/#535) · **next = standing menu, pick ONE:** tree-select #282/#283 (avoid while #526 window open), chip-set #201, carousel #276 swipe/loop, #456 residual (drag-handle / space-6 / file-upload / split-button / multi-select chip), breadcrumb #333 extras · verify: `bash scripts/preflight.sh` **with node on PATH** (nvm bin; else format/build/test/lint silently skip & falsely PASS — #538).
