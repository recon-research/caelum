...
**As of:** 2026-07-27 · main @ `55cacd2` · CI green (full matrix) · **repo LIVE + protected** ([github.com/recon-research/caelum](https://github.com/recon-research/caelum)) · **Phase 2** · **M0 ☑ · M1 ☑ · M2 ☑ · M3 ☑** (grid gap → editor #232 / charts #233; niche widgets #667 → all on-demand per D-18) · **M4 ◐ Parity hardening & adoption** (density R4 #411 · a11y Layer 1 axe #690+#691 · real-browser harness #240 · VR suite ☑ #732 · ledger ☑ #733) · template @ pyxis `79fdfbe`. Full slice index → [`docs/ROADMAP.md`](docs/ROADMAP.md); recipe + gotchas → [`docs/PATTERNS.md`](docs/PATTERNS.md).

**Where we are:** **M4 active**. Shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR ☑ #732 · ledger ☑ #733/#774/#779/#773 (**64/64 + 1 proven exempt**) · **☑ #785** error-state axe · **☑ #765** modals trap focus at attach (prov. #791) · **☑ #759** accordion arrow-key roving (D-623 reach; upstream ask #796) · **☑ #741** pre-touched controls surface their error (shared base → 9 subclasses) · **#734 ◐** (#413 left) · **#405 11/12**. **1949 tests** (caelum 1697 + forge 71 + browser 142 + VR 24 + scripts 15); gates GREEN.

**Next:** M4's exit criteria — **#734** theming polish (◐ — #425 + #510 done; **#413** parked on `decision` #757). **#405** sits at 11/12 pending `decision` **#771**; with #773 closed those two are all that stand between M4 and its exit. Recipes → `docs/PATTERNS.md` §9–§9l/§12–§13. Queued extras: **#709** cae-drawer · #710 cae-alert · #711 cae-panel/fieldset · #648(opt3) · #585.

**Open decisions:** **#735** VR golden portability (prov. Opt 1, pin the render) · **#744** semantic status colours (prov. Opt 2, darken light arms; shipped PR #746) · **#757** compile-time density baseline for #413 (prov. Opt 1, close it — measured) — those three ratify by silence **2026-07-28** · **#771** how to retire the #405 sweep (prov. Opt 1, close it + spin #228 out) ratifies **2026-07-29** · **#791** modal focus-trap default (prov. Opt 1, measured; shipped PR #793) ratifies **2026-07-29** → `D-NN`; each ticket carries the fork + grounding. Decided rows live in ARCHITECTURE Appendix A (the log, not here). **~130 open issues** = deferral log, not a burndown.

**Resume:** `main` @ `55cacd2`, tree clean, CI green · **no in-flight slice** · last shipped: **#741** (PR #800) a control touched *before* `[formControl]` binds surfaces its error — one `afterNextRender` recompute in the shared base, all 9 subclasses (PATTERNS §9l) · **decisions: #735, #744, #757** (ratify 07-28), **#771, #791** (ratify 07-29) · **NEXT: #734** (#413 parked on #757) or an M4 exit pass once #771 lands; queued **#709**/#710/#711 · findings: #796, #792, #787, #769, #766, #762, #758 · verify: `bash scripts/preflight.sh` **node on PATH** (#538), read the **EXIT CODE** (a pipe to `tail` returns the pipe's), and re-run it **after** doc edits — a stale PASS reddened #753.
