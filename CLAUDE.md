...
**Next:** **M4's exit is blocked by clause 2 alone** — **#809**: the ledger proves a pointer resolves, not that a review happened (13 rows cite a packaging slice, 2 self-review). That is the milestone's real risk and the next slice. Then **#811** axe scans one arm · **#812** ledger unit mismatch · **#813**; then **#709**/#710/#711.
...
**Resume:** `main` @ `c74ac47`, tree clean, CI green · **no in-flight slice** · last shipped: **#808+#810** (PR #819) M4 exit clause 1 — reworded off a "parity checklist" that never existed onto COMPARISON's Status column, gated by `scripts/audit_comparison.py` (20th preflight stage; grading **zero rows FAILS**, since the promise's 31 "clean" revisions predate the column) · next: **#809** · also #811, #812, #813, #816 toolchain drift, #817 theming-API hygiene, **#804** escalated · older: #796, #792, #787, #769, #766, #762, #758 · verify: `bash scripts/preflight.sh` **node on PATH** (#538), read the **EXIT CODE**; a Linux preflight cannot see a Windows-only break (#814).
