...
**Resume:** `main` @ `667b487`, tree clean, CI green · last shipped: #201 chip-set `[textEntry]` (PR #554; #201 now listbox-only) · **next = standing menu, pick ONE:** carousel #276 swipe/loop, breadcrumb #333 extras, splitter slop #544/#545, chip-set residuals #550–#553 · ⚠ decision-blocked: tree-select #282/#283 (#526), chip-set listbox (#549), splitter px #418 · verify: `bash scripts/preflight.sh` **with node on PATH** (nvm bin; else format/build/test/lint silently skip & falsely PASS — #538).
