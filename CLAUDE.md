...
**Next:** M4's exit criteria — **#734** theming polish (◐ — #425 + #510 done; **#413** parked on `decision` #757). **#405** sits at 11/12 pending `decision` **#771**; with #773 closed those two are all that stand between M4 and its exit. Recipes → `docs/PATTERNS.md` §9–§9g/§12–§13. Queued extras: **#709** cae-drawer · #710 cae-alert · #711 cae-panel/fieldset · #741 · #648(opt3) · #585.
...
**Resume:** `main` @ `c869fd2`, tree clean, CI green · **no in-flight slice** · last shipped: **#773** ledger axe coverage — 4 entry points covered, `shared` exempt (ledger **64/64 + 1 exempt**) · **decisions: #735, #744, #757** (ratify 07-28), **#771** (ratify 07-29) · **NEXT: #734** (#413 parked on #757) or an M4 exit pass once #771 lands · open findings: #769, #765, #766, #762, #758, #759 · verify: `bash scripts/preflight.sh` **node on PATH** (#538), read the **EXIT CODE** (a pipe to `tail` returns the pipe's), and re-run it **after** doc edits — a stale PASS reddened #753.
