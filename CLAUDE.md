...
**Resume:** `main` @ `7a37564`, tree clean, CI green · last shipped: status-anchor guard #525 (PR #568) · **in flight: carousel #560** indicator roving-tabindex (derive arrow targets from `clampedPage()`, not the pressed index) · then standing menu: breadcrumb #333 extras, splitter slop #544/#545, chip-set #552/#553/#556 · #559 is **M4-gated** (jsdom can't model `inert` blur) · ⚠ decision-blocked: tree-select #282/#283 (#526), chip-set listbox (#549), splitter px #418 · verify: `bash scripts/preflight.sh` **with node on PATH** (nvm bin; else format/build/test/lint silently skip & falsely PASS — #538).
