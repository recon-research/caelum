...
**Resume:** `main` @ `1ff0de1`, tree clean, CI green · last shipped: carousel #276 touch swipe (PR #561; #276 keeps the seamless-loop item) · **next = standing menu, pick ONE:** breadcrumb #333 extras, splitter slop #544/#545, chip-set #552/#553/#556, carousel #560 roving-tabindex · ⚠ decision-blocked: tree-select #282/#283 (#526), chip-set listbox (#549), splitter px #418 · verify: `bash scripts/preflight.sh` **with node on PATH** (nvm bin; else format/build/test/lint silently skip & falsely PASS — #538).
