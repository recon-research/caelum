...
**Resume:** `main` @ `bea3428`, tree clean, CI green · **no in-flight slice** · last shipped: **#765** (PR #793) modals now trap focus at attach — measured, mutation-tested, prov. on **#791** · **decisions: #735, #744, #757** (ratify 07-28), **#771, #791** (ratify 07-29) · **NEXT: #734** (#413 parked on #757) or an M4 exit pass once #771 lands · open findings: #792, #787, #769, #766, #762, #758, #759 · verify: `bash scripts/preflight.sh` **node on PATH** (#538), read the **EXIT CODE** (a pipe to `tail` returns the pipe's), and re-run it **after** doc edits — a stale PASS reddened #753.
