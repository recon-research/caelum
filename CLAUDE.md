...
**Next:** **port per-component real-browser checks** now the harness exists — 14 tickets were blocked on it (#41 #79 #91 #107 #110 #128 #138 #155 #158 #165 #174 #223 #228 #236); **#718** (grid `role=status` in `role=table`, axe critical) is the first, found by the harness itself. Then: theming polish (density × scheme) · visual-regression suite · capability ledger green. Queued extras: **#709** cae-drawer · #710 cae-alert · #711 cae-panel/fieldset · #648(opt3) · #585.
