...
**As of:** 2026-07-27 · main @ `1f81fe5` · CI green (full matrix) · **repo LIVE + protected** ([github.com/recon-research/caelum](https://github.com/recon-research/caelum)) · **Phase 2** · **M0 ☑ · M1 ☑ · M2 ☑ · M3 ☑** (grid gap → editor #232 / charts #233; niche widgets #667 → all on-demand per D-18) · **M4 ◐ — exit review RAN 2026-07-27 and the exit FAILED it: #808–#812** (#411 · #690+#691 · #240 · VR ☑ #732 · ledger ☑ #733 · theming ☑ #734) · template @ pyxis `79fdfbe`. Full slice index → [`docs/ROADMAP.md`](docs/ROADMAP.md); recipe + gotchas → [`docs/PATTERNS.md`](docs/PATTERNS.md).

**Where we are:** **M4 active**. Shipped: density R4 #411 · a11y axe #690+#691 · hardening (PRs #697–#705) · adoption #713/#716 · harness #240 · VR ☑ #732 · ledger ☑ #733/#774/#779/#773 (**64/64 + 1 proven exempt**) · **☑ #785** error-state axe · **☑ #765** modals trap focus at attach (prov. #791) · **☑ #759** accordion arrow-key roving (D-623 reach; upstream ask #796) · **☑ #741** pre-touched controls surface their error (shared base → 9 subclasses) · **☑ #734** theming, closed by **☑ #413** `caelum.theme()` mixin (D-757) · **#405 11/12**. **1967 tests** (caelum 1700 + forge 71 + browser 142 + VR 24 + scripts 30); gates GREEN.

**Next:** **M4's exit is blocked by its own review** (ran 2026-07-27, 4 lenses). Clause 1 names a "parity checklist" that exists nowhere (**#808**) and clause 2's ledger proves a pointer resolves, not that a review happened (**#809**); also **#810** 4 untracked `p-*` · **#811** axe scans one arm · **#812** ledger unit mismatch. Take #808+#810 first — together they make clause 1 gradeable. Then **#709**/#710/#711.
...
**Resume:** `main` @ `1f81fe5`, tree clean, CI green · **no in-flight slice** · last shipped: **#413** (PRs #806/#814) the `caelum.theme()` mixin + hardening — the guard validates `0…-5` and needs `$density-compact` strictly tighter or `null`, since the old `==` proxy missed an *inverted* arm · **M4 exit FAILED its review** → **#808–#813** (start #808+#810: they make clause 1 gradeable; #809 holds the real risk) · also #816 toolchain drift, #817 theming-API hygiene, **#804** escalated · older: #796, #792, #787, #769, #766, #762, #758 · verify: `bash scripts/preflight.sh` **node on PATH** (#538), read the **EXIT CODE**; a Linux preflight cannot see a Windows-only break (#814).
