...
**Next:** M5 parity track, in order: **#711** `cae-panel`/`cae-fieldset` · **#150** `cae-menu` submenus · **#120** (*only* the `p-chips` form/CVA half closes the row). Then release: **#514** rename → **#851** release engineering → **#852** publish `0.1.0` (**owner-run**). Carried, non-gating: #811/#812/#813/#832/#836/#840/#844/#846/#228 + #854–#858 (drawer) + #863–#866 (alert).
