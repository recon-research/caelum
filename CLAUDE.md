...
**As of:** 2026-07-26 · main @ `430d8f8` · CI green (full matrix) · **repo LIVE + protected** ([github.com/recon-research/caelum](https://github.com/recon-research/caelum)) · **Phase 2** · **M0 ☑ · M1 ☑ · M2 ☑ · M3 ☑** (grid gap → editor #232 / charts #233; niche widgets #667 → all on-demand per D-18) · **M4 ◐ Parity hardening & adoption** (density R4 #411 · a11y Layer 1 axe #690+#691 · real-browser harness #240 · VR suite ☑ #732 · ledger ☑ #733) · template @ pyxis `79fdfbe`. Full slice index → [`docs/ROADMAP.md`](docs/ROADMAP.md); recipe + gotchas → [`docs/PATTERNS.md`](docs/PATTERNS.md).

**Where we are:** **M4 active**. Shipped: density R4 #411 · a11y Layer 1 axe #690+#691 · 07-24 hardening batch (PRs #697–#705) · adoption track (#713, #716) · **harness #240** (PR #719) · **#405 sweep 11/12** (PR #770 closed the last workable box and fixed a live-region a11y-tree defect in cae-table + cae-tree-table) · **VR suite ☑ #732** (PRs #737/#742; goldens agree across dev box, container and CI runner) · **#734 ◐** — #425 contrast (PR #746), #745 status palette under VR (PR #748), **#510** bridge map pinned (PR #753) · **ledger ☑ #733** (PR #775; 59/65 signed off, gaps → #773/#774). **1917 tests** (caelum 1674 + forge 71 + browser 133 + VR 24 + scripts 15); gates GREEN.

**Next:** M4's two exit criteria are now **#734** theming polish (◐ — #425 + #510 done; **#413** remains, parked on `decision` #757) and the **ledger's own gaps** — **#773** (5 entry points with no axe assertion; may need an exemption mechanism) + **#774** (cae-panel-menu is the invariant's only unsigned row). **#405** sits at 11/12 pending `decision` **#771**. Recipes → `docs/PATTERNS.md` §9–§9g/§12. Queued extras: **#709** cae-drawer · #710 cae-alert · #711 cae-panel/fieldset · #741 · #648(opt3) · #585.

**Open decisions:** **#735** VR golden portability (prov. Opt 1, pin the render) · **#744** semantic status colours (prov. Opt 2, darken light arms; shipped PR #746) · **#757** compile-time density baseline for #413 (prov. Opt 1, close it — measured) — those three ratify by silence **2026-07-28** · **#771** how to retire the #405 sweep (prov. Opt 1, close it + spin #228 out) ratifies **2026-07-29** → `D-NN`; each ticket carries the fork + grounding. Recently decided: **D-526 · D-549 · D-595 · D-596 · D-614 · D-623 · D-652** (prior **D-428/D-501**; full log → ARCHITECTURE Appendix A). **~130 open issues** = deferral log, not a burndown.

**Resume:** `main` @ `430d8f8`, tree clean, CI green · **no in-flight slice** · last shipped: **#733** capability ledger (PR #775) — `docs/CAPABILITY_LEDGER.md` generated + gated, **59/65** at `adversarial-passed` · **decisions: #735, #744, #757** (ratify 07-28), **#771** (ratify 07-29) · **NEXT: #734** theming polish (#413 parked on #757) or the ledger gaps **#773**/**#774** · new: **#773**, **#774**, #769, #765, #766, #762, #758, #759 · verify: `bash scripts/preflight.sh` **node on PATH** (#538), read the **EXIT CODE** (a pipe to `tail` returns the pipe's), and re-run it **after** doc edits — a stale PASS reddened #753.
